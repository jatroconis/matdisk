...
import { calJorgeBoole } from "../../utils/methods/jorgeboole";
import { restrap, CalcDeltaBoole } from "../../utils/methods/mathMethods";


const CardJorgeBoole = (props : any) => {
    ...
    return (
        <>
          <Card>
            ...
            <Card.Body>
              <Card.Title>METODO JORGE BOOLE</Card.Title>
              <Card.Text>
                <>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setResult({
                      registro: calJorgeBoole(func,  limitsup, limitinf)
                        .registro,
                      resultado: calJorgeBoole(func, limitsup, limitinf)
                        .resultado,
                    });
                    setDelta(CalcDeltaBoole(limitsup, limitinf));
                  }}
                >
                  Calcular
                </Button>
