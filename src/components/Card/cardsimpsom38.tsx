...
import { Caltsimpson38 } from "../../utils/methods/tsimsomp38";
import { CalcDeltaSimpsom38, restrap } from "../../utils/methods/mathMethods";

const CardSimpsom38 = (props: any) => {
          ...
          <Card.Text>
            ...
            <Button
              ...
              onClick={() => {
                ...
                setResult({
                  registro: Caltsimpson38(func,  limitsup, limitinf)
                    .registro,
                  resultado: Caltsimpson38(func,  limitsup, limitinf)
                    .resultado,
                });
                setDelta(CalcDeltaSimpsom38(limitsup, limitinf));
              }}
            >
              Calcular
            </Button>
